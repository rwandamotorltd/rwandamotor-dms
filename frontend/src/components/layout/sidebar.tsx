...
const NAV_ITEMS: NavItem[] = [
  ...
  { href: "/follow-ups",        label: "Follow-ups",      icon: PhoneCall,       permission: "nav.followUps" },
  { href: "/appointments",      label: "Appointments",    icon: CalendarDays,    permission: "nav.appointments" },
  { href: "/reports",           label: "Reports",         icon: BarChart2,       permission: "nav.reports" },
