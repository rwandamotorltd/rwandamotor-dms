...
namespace RwandaMotor.Infrastructure.Migrations
{
    ...
    [Migration("20260624081238_AddAppRoles")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RwandaMotor.Domain.Entities.AppRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("RwandaMotor.Domain.Entities.Appointment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("CompletedJobCardId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("RwandaMotor.Domain.Entities.AuditLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("RwandaMotor.Domain.Entities.DocumentTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("RwandaMotor.Domain.Entities.FollowUpInteraction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("FollowUpInteractions");
                });
            ...
            modelBuilder.Entity("RwandaMotor.Domain.Entities.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("RwandaMotor.Domain.Entities.Appointment", b =>
                {
                    ...
                    b.HasOne("RwandaMotor.Domain.Entities.FollowUp", "FollowUp")
            ...
            modelBuilder.Entity("RwandaMotor.Domain.Entities.Notification", b =>
                {
                    b.HasOne("RwandaMotor.Domain.Entities.Appointment", "Appointment")
                        .WithMany()
