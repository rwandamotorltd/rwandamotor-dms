    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkshopBays", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ImportLogRows", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ImportLogRows_ImportLogs_ImportLogId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DueSoonLeadKm = table.Column<int>(type: "integer", nullable: false),
                    LostThresholdMonths = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServicePolicies_Brands_BrandId",
                        column: x => x.BrandId,
                        principalTable: "Brands",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_ServicePolicies_VehicleModels_ModelId",
                        column: x => x.ModelId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsSoldByDealership = table.Column<bool>(type: "boolean", nullable: false),
                    ...
                    WarrantyKmLimit = table.Column<int>(type: "integer", nullable: true),
                    ServicePolicyId = table.Column<Guid>(type: "uuid", nullable: true),
                    RetentionStatus = table.Column<int>(type: "integer", nullable: false),
                    RetentionStatusUpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    Notes = table.Column<string>(type: "text", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Vehicles_ServicePolicies_ServicePolicyId",
                        column: x => x.ServicePolicyId,
                        principalTable: "ServicePolicies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecoveryAchieved = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
                    UpdatedBy = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FollowUps_Vehicles_VehicleId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PartsCost = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    TotalCost = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    NextServiceMileage = table.Column<int>(type: "integer", nullable: true),
                    NextServiceDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    Notes = table.Column<string>(type: "text", nullable: true),
                    IsWarrantyJob = table.Column<bool>(type: "boolean", nullable: false),
                    IsRecallJob = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
                    UpdatedBy = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServiceRecords_Technicians_TechnicianId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ServiceRecords_WorkshopBays_BayId",
                        column: x => x.BayId,
                        principalTable: "WorkshopBays",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FollowUps_VehicleId",
                table: "FollowUps",
                column: "VehicleId");

            migrationBuilder.CreateIndex(
                name: "IX_ImportLogRows_ImportLogId",
                table: "ImportLogRows",
                column: "ImportLogId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServicePolicies_BrandId",
                table: "ServicePolicies",
                column: "BrandId");

            migrationBuilder.CreateIndex(
                name: "IX_ServicePolicies_ModelId",
                table: "ServicePolicies",
                column: "ModelId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceRecords_BayId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceRecords_TechnicianId",
                table: "ServiceRecords",
                column: "TechnicianId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Vehicles_NextServiceDate",
                table: "Vehicles",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Vehicles_RetentionStatus",
                table: "Vehicles",
                column: "RetentionStatus");

            migrationBuilder.CreateIndex(
                name: "IX_Vehicles_SaleDate",
                table: "Vehicles",
                column: "SaleDate");

            migrationBuilder.CreateIndex(
                name: "IX_Vehicles_ServicePolicyId",
                table: "Vehicles",
